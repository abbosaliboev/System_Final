...
CONFIGS = [
    {
        "label":      "A: best_detect.engine + Pose 17kp (best_pose.engine)",
        "ppe_paths":  ["monitor/YOLO/models/best_detect.engine",
                       "monitor/YOLO/models/best_detect.pt"],
        "pose_paths": ["monitor/YOLO/models/best_pose.engine",
                       "monitor/YOLO/models/yolo11n-pose.pt"],
        "frame_diff": False,
        "kp_count":   17,
    },
    {
        "label":      "B: best_detect.engine + Pose 10kp (yolo11n-10kp.pt)",
        "ppe_paths":  ["monitor/YOLO/models/best_detect.engine",
                       "monitor/YOLO/models/best_detect.pt"],
        "pose_paths": ["monitor/YOLO/models/yolo11n-10kp.pt"],
        "frame_diff": False,
        "kp_count":   10,
    },
    {
        "label":      "C: unify-29march.engine + Pose 10kp (shared backbone)",
    ...
    {
        "label":      "D: unify-29march.engine + Pose 10kp + Frame Differencing",
        "ppe_paths":  ["monitor/YOLO/models/unify-29march.engine",
                       "monitor/YOLO/models/unify-29march.pt"],
        "pose_paths": ["monitor/YOLO/models/yolo11n-10kp.pt"],
        "frame_diff": True,
